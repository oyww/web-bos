...
<!-- 展示分布图分区 -->
<div class="easyui-window" title="展示分区" id="showSubareaWindow" collapsible="false" minimizable="false"
     maximizable="false" style="top:20px;left:200px">
    <div id="showSubarea" split="false" border="false">
